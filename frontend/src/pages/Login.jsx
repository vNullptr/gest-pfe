    ...
    <div className='flex flex-row items-center min-h-screen overflow-hidden bg-white'>
      ...
      <div className="flex flex-col items-center rounded-[5px] min-w-[400px] py-[30px] w-1/2 space-y-3 p-15">
          ...
          <div className="relative">
            <input className="px-3 border border-gray-300 outline-0 rounded-md p-[3px] focus:border-primary w-90 h-11" type="email" placeholder='Entrez ici'></input>
            <label className="absolute -top-2 left-3 text-gray-400 text-[10px] bg-white px-1">Email</label>
          </div>
          <div className="relative">
            <input className="px-3 border border-gray-300 outline-0 rounded-md focus:border-primary w-90 h-11" type="password" placeholder='Entrez ici'></input>
            <label className="absolute -top-2 left-3 text-gray-400 text-[10px] bg-white px-1">Mots de passe</label>
          </div>
          <button className="p-[7px] bg-primary rounded-md text-white font-bold text-[1.1em] text-md shadow-md hover:bg-[#037fc7] transition-all duration-200 w-90 h-12">Se connecter</button>
