    ...
    <div className="p-5 sticky">
        <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="relative">
                ...
                <select className="border border-gray-200 rounded-md outline-none p-1 w-full min-h-9 text-gray-900" value={user?.role} onChange={(e)=>setUser(prev=>({...prev, role:Number(e.target.value)}))}>
            ...
            <div className="flex flex-row justify-between">
                ...
                <div className="space-x-1">
                    <button className="p-2 bg-white border border-red-600 text-red-600 hover:bg-red-500 hover:text-white rounded-md transition-all duration-200" onClick={handleDelete}>Supprimer</button>
